...
inference(y = weeks, data = nc, statistic = "mean", type = "ci", null = 0, conf_level = 0.99, 
          alternative = "twosided", method = "theoretical")
```
...
inference(y = weeks, data = nc, statistic = "mean", type = "ci", null = 0, conf_level = 0.90, 
          alternative = "twosided", method = "theoretical")
```
...
inference(y = weight, x= mature, data = nc, statistic = "mean", type = "ci", null = 0, alternative = "twosided", method = "theoretical")
```
